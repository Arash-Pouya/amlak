    ...
    (x.VERSION = "1.13.1"),
      ...
      (x.prototype = {
          ...
          function e(a, d) {
            ...
            if (
              ...
              void 0 !== f.activeIndex &&
                ...
                d && (f.activeIndex !== f.selectedIndex && (i.classList.remove("active"), i.firstChild && i.firstChild.classList.remove("active")), (f.activeIndex = void 0)),
                f.activeIndex && f.activeIndex !== f.selectedIndex && g && g.length && (g.classList.remove("active"), g.firstChild && g.firstChild.classList.remove("active"))),
              void 0 !== f.prevActiveIndex && f.prevActiveIndex !== f.activeIndex && f.prevActiveIndex !== f.selectedIndex && h && h.length && (h.classList.remove("active"), h.firstChild && h.firstChild.classList.remove("active")),
              (d || n) &&
                ((o = f.selectpicker.view.visibleElements ? f.selectpicker.view.visibleElements.slice() : []),
                (f.selectpicker.view.visibleElements = f.selectpicker.current.elements.slice(f.selectpicker.view.position0, f.selectpicker.view.position1)),
                f.setOptionStatus(),
              ...
              !0 === t &&
                ((w = 0 === f.selectpicker.view.position0 ? 0 : f.selectpicker.current.data[f.selectpicker.view.position0 - 1].position),
                (x = f.selectpicker.view.position1 > p - 1 ? 0 : f.selectpicker.current.data[p - 1].position - f.selectpicker.current.data[f.selectpicker.view.position1 - 1].position),
          ...
          x.each(function (k) {
            ...
            if ((j++, !l.hasClass("bs-title-option"))) {
              ...
              if (F && !0 !== t.divider) {
                ...
                I && "divider" !== g[g.length - 1].type && (j++, d.push(n(!1, 0, u.DIVIDER, h + "div")), g.push({ type: "divider", optID: h, originalIndex: k })),
        ...
        setMenuSize: function (a) {
          ...
          if (
            (this.options.dropupAuto &&
              ((h = j * this.selectpicker.current.elements.length + p.vert), this.$newElement.toggleClass(u.DROPUP, this.sizeInfo.selectOffsetTop - this.sizeInfo.selectOffsetBot > this.sizeInfo.menuExtras.vert && h + this.sizeInfo.menuExtras.vert + 50 > this.sizeInfo.selectOffsetBot)),
            "auto" === this.options.size)
          )
            (e = this.selectpicker.current.elements.length > 3 ? 3 * this.sizeInfo.liHeight + this.sizeInfo.menuExtras.vert - 2 : 0),
          ...
          c || (c = this.selectpicker.main.map.newIndex[a]),
            ...
            j ||
              (!h &&
                ...
                ((e = this.selectpicker.main.map.newIndex[this.prevActiveIndex]), (f = this.selectpicker.main.elements[e]), f.classList.remove("selected"), f.classList.remove("active"), f.firstChild && (f.firstChild.classList.remove("selected"), f.firstChild.classList.remove("active"))));
        },
        ...
        checkDisabled: function () {
          var a = this;
          this.isDisabled()
            ? (this.$newElement.addClass(u.DISABLED), this.$button.addClass(u.DISABLED).attr("tabindex", -1).attr("aria-disabled", !0))
            : (this.$button.hasClass(u.DISABLED) && (this.$newElement.removeClass(u.DISABLED), this.$button.removeClass(u.DISABLED).attr("aria-disabled", !1)), -1 != this.$button.attr("tabindex") || this.$element.data("tabindex") || this.$button.removeAttr("tabindex")),
              ...
              if (((a.selectpicker.search.map.newIndex = {}), (a.selectpicker.search.map.originalIndex = {}), (a.selectpicker.search.elements = []), (a.selectpicker.search.data = []), c)) {
                ...
                for (var e = 0, m = i.length; e < m; e++) {
                  ...
                  ("divider" !== l.type || ("divider" === l.type && q && "divider" !== q.type && m - 1 !== e)) &&
                    (a.selectpicker.search.data.push(l), f.push(a.selectpicker.main.elements[n]), (a.selectpicker.search.map.newIndex[l.originalIndex] = f.length - 1), (a.selectpicker.search.map.originalIndex[f.length - 1] = l.originalIndex));
                }
        ...
        keydown: function (b) {
          ...
          if (
            ...
            !e && (o || (b.which >= 48 && b.which <= 57) || (b.which >= 96 && b.which <= 105) || (b.which >= 65 && b.which <= 90)) && k.$button.trigger("click.bs.dropdown.data-api"),
            ...
            (c = !0 === q ? l.index(l.filter(".active")) : k.selectpicker.current.map.newIndex[k.activeIndex]),
              ...
              b.which === s.ARROW_UP
                ? (-1 !== c && c--, c + t < 0 && (c += l.length), k.selectpicker.view.canHighlight[c + t] || (-1 === (c = k.selectpicker.view.canHighlight.slice(0, c + t).lastIndexOf(!0) - t) && (c = l.length - 1)))
                : (b.which === s.ARROW_DOWN || n) && (c++, c + t >= k.selectpicker.view.canHighlight.length && (c = 0), k.selectpicker.view.canHighlight[c + t] || (c = c + 1 + k.selectpicker.view.canHighlight.slice(c + t + 1).indexOf(!0))),
              b.preventDefault();
            var x = t + c;
            b.which === s.ARROW_UP
              ? 0 === t && c === l.length - 1
                ? ((k.$menuInner[0].scrollTop = k.$menuInner[0].scrollHeight), (x = k.selectpicker.current.elements.length - 1))
                : ((g = k.selectpicker.current.data[x]), (h = g.position - g.height), (m = h < p))
              : (b.which === s.ARROW_DOWN || n) && (0 !== t && 0 === c ? ((k.$menuInner[0].scrollTop = 0), (x = 0)) : ((g = k.selectpicker.current.data[x]), (h = g.position - k.sizeInfo.menuInnerHeight), (m = h > p))),
          ...
          e &&
            ((b.which === s.SPACE && !k.selectpicker.keydown.keyHistory) || b.which === s.ENTER || (b.which === s.TAB && k.options.selectOnTab)) &&
            (b.which !== s.SPACE && b.preventDefault(), (k.options.liveSearch && b.which === s.SPACE) || (k.$menuInner.find(".active a").trigger("click", !0), i.focus(), k.options.liveSearch || (b.preventDefault(), a(document).data("spaceSelect", !0))));
        },
        mobile: function () {
